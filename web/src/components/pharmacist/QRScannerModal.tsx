...
import { X, Scan, Upload, Type, Image as ImageIcon } from "lucide-react";
...
const QRScannerModal = ({ isOpen, onClose, onScan }: QRScannerModalProps) => {
  ...
  const processQRCode = async (imageUrl: string) => {
    ...
    try {
      ...
      // Success - call onScan with the extracted batch ID
      onScan(batchId);
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>
            Upload a QR code image or manually enter batch information
          </CardDescription>
        </CardHeader>
