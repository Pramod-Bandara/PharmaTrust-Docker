...
export function isValidStageTransition(currentStage, newStage) {
    const stageOrder = ['manufacturer', 'supplier', 'pharmacist', 'customer'];
...
export function detectAnomaly(temperature, humidity, batchId) {
    const anomalies = [];
    let maxSeverity = 'low';
...
export function createQualityAlert(environmentalData, anomalyResult) {
...
export function calculateQualityStatus(alerts) {
...
export function formatBatchResponse(batch) {
    return {
...
// Sort helper
export function getSortParams(query) {
